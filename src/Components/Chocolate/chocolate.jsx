...
class chocolate extends Component {
    componentDidMount(){
        this.props.getRecipes("chocolate")
    }
    goToURL = (id)=>{
        window.open(this.props.choclateRecipe[id].source_url)
    }
    goToDetail = (recipeId)=>{
            ...
            <React.Fragment>
                <section className = "my-5 py-5">
                    <div className="container">
                        <div className="row">
                            {this.props.choclateRecipe.map((item , index)=>{
                                return(
...
function mapStateToProps(state){
    return{
        choclateRecipe : state.recipes
    }
}
export default connect(mapStateToProps,{getRecipes})(chocolate);