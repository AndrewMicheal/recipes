...
class Beef extends Component {
    componentDidMount(){
        this.props.getRecipes("beef")
    }
    goToURL = (id)=>{
        window.open(this.props.beefRecipe[id].source_url)
    }
    goToDetail = (recipeId)=>{
        ...
        return (
            ...
            <section className = "my-5 py-5">
                <div className="container">
                    <div className="row">
                        {this.props.beefRecipe.map((item , index)=>{
                            return(
...
function mapStateToProps(state){
    return{
        beefRecipe : state.recipes
    }
}
export default connect(mapStateToProps,{getRecipes})(Beef);